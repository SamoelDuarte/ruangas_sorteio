            ...
            @foreach ($clientes as $cliente)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('cliente.destroy', $cliente->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDelete()">
                            @csrf
                            @method('DELETE')
                        ...
                        <select class="form-select" id="sorteio_id" name="sorteio_id" required>
                            ...
                            @foreach($sorteios as $sorteio)
                                <option value="{{ $sorteio->id }}">
                                    {{ $sorteio->nome }} - Início: {{ $sorteio->data_inicio_formatada }} - Fim: {{ $sorteio->data_fim_formatada }}
                                </option>
                            @endforeach
                        </select>
                    </div>
